...
const specializationQuestions = [
    ...
    questions: [
      {
        ...
        options: ["a) Compass", "b) Ruler", "c) Protractor", "d) French curve"],
        answer: "b) Ruler",
        type: "multiple-choice",
      },
      {
...

  {
    ...
    questions: [
      ...
      {
        question: "These are fundamentals of electrical maintenance except for",
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["a) A magnetic field", "b) An electric field", "c) Voltage"],
...

  {
    ...
    questions: [
      ...
      {
        question: "Which weld procedure is safe to perform in wet conditions? ",
...

  {
    ...
    questions: [
      ...
      {
        question: "It is the study or art of cosmetics and their application.",
        options: ["a) Cosmetics/Cosmetic", "b) Cosmetology"],
...
specializationQuestions.forEach((specialization) => {
  const specializationRef = db.collection("SpecializationQuestions").doc();
  batch.set(specializationRef, {
    specialization: specialization.specialization,
    questions: specialization.questions.map((question) => ({
